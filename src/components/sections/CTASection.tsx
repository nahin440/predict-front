  ...
  return (
    <section style={{ padding:"100px 0", position:"relative", overflow:"hidden", background:"var(--ink)" }}>
      ...
      <div style={{ position:"relative",zIndex:2,maxWidth:700,margin:"0 auto",padding:"0 24px",textAlign:"center" }}>
        ...
        <h2 style={{ fontFamily:"Syne",fontSize:"clamp(32px,4.5vw,60px)",fontWeight:800,letterSpacing:"-0.04em",marginBottom:20,lineHeight:1.0 }}>
          <span style={{ color:"var(--paper)" }}>Ready to Trade</span><br />
          <span className="text-gradient-gold">With Real Intelligence?</span>
        </h2>
        <p style={{ fontFamily:"Space Grotesk",fontSize:16,color:"var(--fog)",lineHeight:1.7,marginBottom:40,maxWidth:460,margin:"0 auto 40px" }}>
        ...
        <p style={{ fontFamily:"JetBrains Mono",fontSize:10,color:"var(--steel)",marginTop:24,letterSpacing:"0.06em" }}>
