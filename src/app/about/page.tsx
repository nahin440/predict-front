      ...
      <div style={{ paddingTop: 120, paddingBottom: 96 }} className="bg-grid">
        <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 24px" }}>
          <div style={{ textAlign: "center", marginBottom: 64 }}>
            ...
            <h1 style={{ fontFamily: "Syne", fontSize: "clamp(32px,4vw,52px)", fontWeight: 800, letterSpacing: "-0.04em", marginBottom: 20 }}>
              Built by Traders, <br />for Traders.
            </h1>
            <p style={{ fontFamily: "DM Sans", fontSize: 17, color: "var(--tx-1)", lineHeight: 1.7, maxWidth: 580, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, marginBottom: 48 }} className="about-grid">
            {[
              ...
              <div key={s.title} className="card" style={{ padding: "28px 24px" }}>
                ...
                <h3 style={{ fontFamily: "Syne", fontSize: 17, fontWeight: 700, marginBottom: 10, color: "#f59e0b" }}>{s.title}</h3>
                <p style={{ fontFamily: "DM Sans", fontSize: 13, color: "var(--tx-2)", lineHeight: 1.7 }}>{s.content}</p>
              </div>
            ))}
          </div>

          <div className="card" style={{ padding: "32px 28px", textAlign: "center" }}>
            <p style={{ fontFamily: "DM Sans", fontSize: 13, color: "var(--tx-2)", lineHeight: 1.8, marginBottom: 20 }}>
              ⚠️ <strong style={{ color: "var(--tx-0)" }}>Risk Disclaimer:</strong> GoldPredict AI provides AI-generated signals for informational and educational purposes ONLY. This is not financial advice. Trading gold (XAUUSD) involves substantial risk of loss. Past signal performance does not guarantee future results. Only trade with money you can afford to lose.
            </p>
